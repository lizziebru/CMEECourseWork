...
load_student_work <- function(student_username) {
  ...
  if(file_test("-f",student_file)) {
    ...
    load_test_data[[length(load_test_data)+1]] <-  test_data_updated(name,"name","Lizzie Bru")
    load_test_data[[length(load_test_data)+1]] <-  test_data_updated(preferred_name,"preferred_name","Lizzie")
    load_test_data[[length(load_test_data)+1]] <-  test_data_updated(email,"email","e.bru21@imperial.ac.uk")
    load_test_data[[length(load_test_data)+1]] <-  test_data_correct(username,"eab21",test_username)
  } else {
